...
namespace JobConnect_API.Migrations
{
    ...
    public partial class initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Jobs",
                columns: new[] { "job_id", "description", "location", "salary", "title" },
                values: new object[,]
                {
                    { 1, "Develop web applications.", "New York", 85000.0, "Software Engineer" },
                    { 2, "Analyze datasets and generate insights.", "San Francisco", 65000.0, "Data Analyst" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Applications_account_id",
                table: "Applications",
                column: "account_id");
